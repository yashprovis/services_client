            ...
            child: Column(
              ...
              children: const [
                ...
                Padding(
                  ...
                  child: ScText("Conditions of use",
                ...
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 14),
                  child: ScText("Intellectual property",
                      size: 16, weight: FontWeight.w600),
                ),
                ScText(
                ...
                Padding(
                  padding: EdgeInsets.symmetric(vertical: 14),
                  child: ScText("Disputes", size: 16, weight: FontWeight.w600),
                ),
                ScText(
